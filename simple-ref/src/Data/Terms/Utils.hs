...
termShift d t = walk 0 t
    where
        ...
        walk c (TermRef i t1)                = TermRef i (walk c t1)
        walk c (TermDeref i t1)              = TermDeref i (walk c t1)
        walk c (TermBecomes i t1 t2)         = TermBecomes i (walk c t1) (walk c t2)
        walk c (TermEquals i t1 t2)          = TermEquals i (walk c t1) (walk c t2)
...
termSub j s (TermRef i t1)                = TermRef i (termSub j s t1)
termSub j s (TermDeref i t1)              = TermDeref i (termSub j s t1)
termSub j s (TermBecomes i t1 t2)         = TermBecomes i (termSub j s t1) (termSub j s t2)
termSub j s (TermEquals i t1 t2)          = TermEquals i (termSub j s t1) (termSub j s t2)
